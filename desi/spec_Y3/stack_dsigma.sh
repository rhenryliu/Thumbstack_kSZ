...
python -u dsigma_thumbstack_yaml.py -p ./configs/diskring_SGC.yaml
# python -u dsigma_thumbstack_yaml.py -p ./configs/dsigma_NGC.yaml
# python -u dsigma_thumbstack.py '{"filterType": "DSigma"}'
# python -u dsigma_thumbstack_SGC.py '{"filterType": "diskring"}'
# python -u dsigma_thumbstack.py '{"filterType": "diskring"}'